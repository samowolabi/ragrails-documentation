...
| Endpoint | Runs |
| --- | --- |
| `POST /v1/pipelines/ingest` | extraction -> chunking -> embedding -> storing from JSON sources |
| `POST /v1/pipelines/ingest/mixed` | multipart upload manifest -> extraction -> chunking -> embedding -> storing |
...
| --- | --- | --- |
| [Extraction](/usage/server/extraction) | `/v1/ingest/url`, `/v1/ingest/docs`, `/v1/ingest/docs/upload`, `/v1/ingest/api` | Normalized documents in `outputs` |
