...
| --- | --- | --- |
| Re-ingest | `POST /v1/pipelines/ingest` or `POST /v1/pipelines/ingest/mixed` | Refresh a whole source or collection slice. Use mixed ingest when uploads are part of the refresh. |
